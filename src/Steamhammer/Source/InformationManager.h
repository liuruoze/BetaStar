...
class InformationManager 
{
    ...
    bool			_DThasAttacked; //by ruo-ze, whether our dt has make the first attack, which means enemy has known us.
	...
	BWTA::BaseLocation *                                _myThirdBaseLocation; // whether taken yet or not; may be null
	BWTA::BaseLocation *                                _enemyNaturalBaseLocation;  // whether taken yet or not; may be null
	BWTA::BaseLocation *                                _enemyThirdBaseLocation;  // whether taken yet or not; may be null
	...
	void                    initializeOurThirdBase(bool needMineralOnly = true);
	void					initializeEnemyNaturalBase();
	void					initializeEnemyThirdBase();
	...
	bool                    isNearlyExplored(BWAPI::TilePosition position);
...
public:
	...
	bool					isEnemyWorkerOrFighterInRegion(BWAPI::TilePosition pos);
	...
	BWAPI::Position         getPressingPosition();
	BWAPI::Position			getDefendPosition();
	BWAPI::Position         getAttackingEnemyPosition();
	BWAPI::Position         getMapMiddlePosition();
	...
	BWTA::BaseLocation *	getMyThirdLocation();
	BWTA::BaseLocation *	getEnemyThirdLocation();
	BWTA::BaseLocation *    getFrontBaseLocation();
	BWTA::BaseLocation *    getAirBaseLocation();

	std::vector<BWTA::BaseLocation *> getUnknownBases();
    void detectEnemyBases(const BWAPI::Unit & detectorUnit, int direction, unsigned seed);
	bool sortUnknownBases(BWTA::BaseLocation * i, BWTA::BaseLocation * j);
