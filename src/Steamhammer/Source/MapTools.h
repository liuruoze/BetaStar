...
class MapTools
{
	...
	BWTA::BaseLocation *nextExpansion(bool hidden, bool wantMinerals, bool mineralOnly);
...
public:
	...
	BWAPI::TilePosition	getNextExpansion(bool hidden, bool wantMinerals, bool mineralOnly);
