...
class CombatCommander
{
	...
	void			updatePressingSquads();
	void			updateWaitDropTanksSquads();
	void            updateAirDropSquads();
	void			updateClearCPSquad();
	...
	bool			unitIsGoodToDropInTanks(const BWAPI::Unit unit) const;
	...
	BWAPI::Position getPressingLocation(const Squad * squad);
