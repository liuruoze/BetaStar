...
void ProductionManager::manageBuildOrderQueue()
{
  ...
  while (!_queue.isEmpty())
  {
    ...
    if (_outOfBook && currentItem.macroAct.isUnit())
    {
      ...
      // - Only build at most 3 per nexus // 4 changed by ruo-ze
      ...
      // - Only build at most 3 per nexus // changed code by ruo-ze
      ...
      // Rules for forges:
      // - Only build at most one per 3 nexuses // changed to 1 by ruo-ze
