...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/BetaStar.json";
    }
    ...
    namespace BotInfo
    {
        std::string BotName                 = "BetaStar, based on CSE";
        std::string Authors                 = "Ruo-Ze Liu, Yuntao Ma, Haifeng Guo, Yuzhou Wu, Yuanhao Zheng, Zitai Xiao, Tong Lu";
    ...
    namespace Debug								
    {
        ...
        std::string ErrorLogFilename        = "BetaStar_ErrorLog.txt";
    ...
    namespace Macro
    {
		...
		int NumObservers					= 5;
		int CounterTerranPushTime			= 12;
		int FinalAttackTerranTime			= 24;
    }
